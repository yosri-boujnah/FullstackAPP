...
const SignUpRole = (props) => {
  ...
  return (
    <div className='flex items-center justify-center flex-col mt-10'>
        ...
        <div className="client border-4 p-2 rounded-xl cursor-pointer hover:border-[#108a00]" onClick={()=>props.setRole('client')}>
        ...
        <div className="freelancer border-4 rounded-xl p-2 hover:border-[#108a00] cursor-pointer" onClick={()=>props.setRole('freelancer')}>
            <div className="cont flex flex-row justify-between">
