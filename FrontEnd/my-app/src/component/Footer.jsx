...
import Logo from '../image/th-logow.png'
import Ligne from '../image/ligne.png'

const Footer = () => {
  return (
    <>
    <div className="footer bg-[#181818] flex flex-row items-center mt-10  ">
<div className=' flex flex-col ml-20'>
     <div className="sec-1 flex  flex-col ml-20">
        <img src={Logo} className='w-52 mt-8 ' />
         <img src={Ligne} className='ligne' />
     </div>
     <div className="socialmedia p-4 flex flex-col ml-10">
        <h3 className='join-us text-[#fff] text-xl font-semibold ml-28 '>Follow Us</h3>
     <div class="content">
  <div class="benefits mt-4">
    ...
    <div className="quick-links absolute">
        <h3 className='text-[#fff] text-2xl font-semibold '>Quick Links</h3>
        <ul className='mt-10 flex flex-col gap-4 text-sm'>
        <li className='cursor-pointer text-[#fff] hover:text-[#108a00] font-semibold' >Programming & Tech</li>
        <li className='cursor-pointer text-[#fff] hover:text-[#108a00] font-semibold'>Graphics & Design</li>
        <li className='cursor-pointer text-[#fff] hover:text-[#108a00] font-semibold'>Digital Marketing</li>
        </ul>
    </div>
    <div className='contact-us absolute '>
        <h2 className='text-[#fff] text-2xl font-semibold '>Contact Us</h2>
        <div className="mt-10 flex flex-col gap-4 text-sm">
        <p className='text-[#fff]  font-semibold'>Email: <a href="mailto:support@example.com" >support@example.com</a></p>
        <p className='text-[#fff]  font-semibold'>Phone: <a href="tel:+1234567890">+1 234 567 890</a></p>
        <p className='text-[#fff]  font-semibold'>Address: 1234 Street Name, City, State, 56789</p>
        </div>
      </div>
    </div>
      <div className="copyright p-2 mt-1 flex items-center justify-center">
      <p>&copy; 2024 Your TalentHub. All rights reserved.</p>
